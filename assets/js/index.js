async function getHeadlinesData(){
    const res = await fetch('https://newsapi.org/v2/top-headlines?country=in&apiKey=6b772943c96d488ea6908263f9718bca');
...
async function getStoriesData(){
    let res = await fetch('https://newsapi.org/v2/top-headlines?country=in&apiKey=6b772943c96d488ea6908263f9718bca');
